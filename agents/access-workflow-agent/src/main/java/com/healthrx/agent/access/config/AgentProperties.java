 ...
 * the real-time LLM rate cap), the external payer portal the agent contacts for prior-auth
 * decisions, and the ambient-churn caps for the deterministic benefits/payer beats. See
 * phase-3-design.md §4/§6.
 */
